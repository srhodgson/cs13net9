...
partial class Program
{
    ...
    private static void OutputPQ<TElement, TPriority>(string title, IEnumerable<(TElement Element,
        TPriority Priority)> collection)
    {
        WriteLine($"{title}:");
    ...
    private static void UseDictionary(IDictionary<string, string> dictionary)
    {
        ...
        try
        {
            ...
            // Add method will return type of void.
            dictionary.Add(
